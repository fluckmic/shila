...
tshark -r "$MPTCP_TRAFFIC_PCAP_DUMP_FILENAME" -T fields -e frame.number -e frame.time -e ip.src -e ip.dst -e tcp.len -E separator=, -E header=y > "$MPTCP_TRAFFIC_CSV_DUMP_FILENAME" 2> "$ERR_FILE"
sleep 1